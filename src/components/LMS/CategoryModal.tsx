...
export function CategoryModal({ isOpen, onClose, courseId, category, onSuccess }: CategoryModalProps) {
  ...
  return (
    <div className="fixed inset-0 bg-black bg-opacity-50 md:bg-transparent md:relative flex items-center justify-center z-50 p-0 md:p-0">
      <div className="bg-white rounded-none md:rounded-lg shadow-xl w-full h-full md:max-w-xl md:w-full md:max-h-[90vh] overflow-y-auto md:shadow-none md:bg-transparent">
