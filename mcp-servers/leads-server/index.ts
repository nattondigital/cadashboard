...
/**
 * Leads MCP Server
 * Provides MCP protocol access to lead management functionality
 */
...
const logger = createLogger('LeadsServer');

const SERVER_NAME = process.env.MCP_SERVER_NAME || 'crm-leads-server';
const SERVER_VERSION = process.env.MCP_SERVER_VERSION || '1.0.0';

async function main() {
  logger.info('Starting Leads MCP Server', {
    name: SERVER_NAME,
  ...
  logger.info('Leads MCP Server is running and ready to accept connections');
