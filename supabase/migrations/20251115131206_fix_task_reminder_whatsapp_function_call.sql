/*
  # Fix Task Reminder WhatsApp Function Call

  1. Changes
    - Fix process_due_task_reminders() to call send_followup_whatsapp with correct parameters
    - Add contact_name parameter to match function signature

  2. Purpose
    - Fix the function error that prevents reminders from being processed
    - Enable WhatsApp notifications for task reminders
*/

-- Drop and recreate the function with correct WhatsApp function call
